...
#                 break
    ...
    while line_number != 1:
        while True:
            # Разворот
            keep_yaw(to_180(yaw+90), 0)
            keep_depth(k)
            time.sleep(0.01)
            if to_180(yaw-95) <= auv.get_yaw() <= to_180(yaw-85):
                break
        while True:
            keep_yaw(to_180(yaw+90), -30)
            keep_depth(k)
            time.sleep(0.01)
            _, frame1 = video1.read()  # ПЕРЕДНЯЯ
            _, frame2 = video2.read()  # НИЖНЯЯ
        ...
        while True:
            _, frame1 = video1.read()  # ПЕРЕДНЯЯ
            _, frame2 = video2.read()  # НИЖНЯЯ
            keep_yaw(to_180(yaw+90), -30) # Плывем прямо
            keep_depth(k)
            time.sleep(0.01)
            if search('rect', color_orange, frame2[height//2:]) == 0:
                print('Нашел НЕ оранжевый')
    ...
    #             break
    #         _, frame1 = video1.read()
    #         if search("rect", color_orange, frame1[height-20:]):
    #             print("Нашел оранжевый")
    #             break
    ...
    #         if counter == 1:
    #             break
    #         print("Посчитал кружки")
    #         time.sleep(5)
    #         _, frame1 = video1.read()
    #         print(search("circle", color_black, frame1))
    #         counter += 1
    #         break
    ...
    #         _, frame1 = video1.read()
    #         # print("here")
    #         if search('rect', color_orange, frame1[height-20:])==0:
    #             print("Нашел НЕ оранжевый")
    #             break
