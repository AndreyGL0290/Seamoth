...
#        mur_view.show(frame2, 1) # ДЛЯ РОБОТА
    ...
    print("coming back")
    min_pos, max_pos = find_min_and_max(circles)
    counter = 0
    while counter < len(circles)-min_pos:
            _, frame2 = video2.read()
